...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "data", function() { return data; });
/* harmony import */ var _Users_ross_www_altruist_components_prototype_server_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prototype/server.js */ "./prototype/server.js");


const data = (context, callback) => {
  Object(_Users_ross_www_altruist_components_prototype_server_js__WEBPACK_IMPORTED_MODULE_0__["data"])(context, (error, model) => {
    if (error) {
    ...
    return callback(null, Object.assign({}, {
      reactComponent: {
        key: "e05fa67891ff1b0bebe0b5253f7bd0a17160c536",
